##############################
# coding: utf-8
# use like > nohup python afad-ord-hing-AT.py --cuda 0 &
##############################
# Imports
##############################
import os
...
for RANDOM_SEED in range(10):
    ...
    #
    PATH = "result/ord-hing-AT/seed"+str(RANDOM_SEED)
    ...
    def loss_fn(a, b, levels):
        val = torch.sum((torch.relu(1.+b-a)*levels + torch.relu(1.-b+a)*(1-levels)), dim=1)
