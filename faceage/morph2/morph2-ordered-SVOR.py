##############################
# coding: utf-8
# use like > nohup python morph2-ordered-SVOR.py --cuda 0 &
##############################
# Imports
##############################
import os
...
for RANDOM_SEED in range(20):
    ...
    PATH = "MTM/ordered-SVOR/seed"+str(RANDOM_SEED)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        s = 'MZE/MAE/RMSE | Current : %.4f/%.4f/%.4f/%.4f/%.4f/%.4f Ep. %d Ord. %d/%d/%d/%d | Best-MST : %.4f/%.4f/%.4f Ep. %d/%d/%d | Best-IOT : %.4f/%.4f/%.4f Ep. %d/%d/%d' % (
            MST_Z, MST_A, MST_S, IOT_Z, IOT_A, IOT_S, epoch, b_ord, vz_ord, va_ord, vs_ord, 
