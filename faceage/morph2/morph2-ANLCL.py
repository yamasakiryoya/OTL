...
for RANDOM_SEED in range(20):
    ...
    valid_dataset = MORPH2_Dataset(df=VALID_DF, img_dir=IMAGE_PATH, transform=custom_transform2)
    test_dataset  = MORPH2_Dataset(df=TEST_DF,  img_dir=IMAGE_PATH, transform=custom_transform2)
