##############################
# coding: utf-8
# use like > nohup python morph2-POOCL-NLL.py --cuda 0 &
##############################
# Imports
##############################
import os
...
for RANDOM_SEED in range(10):
    ...
    #
    PATH = "result/POOCL-NLL/seed"+str(RANDOM_SEED)
    ...
    def loss_fn(a, b, targets):
        ...
        tmpr = torch.sigmoid(tmpb[targets+1]-a)
        tmpl = torch.sigmoid(tmpb[targets]-a)
